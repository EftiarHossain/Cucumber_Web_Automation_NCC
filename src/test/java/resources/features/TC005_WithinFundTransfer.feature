...
#    Then I can see transaction confirmation screen for "Within_Bank" transfer with success or fail status and the details of the transactions
#    Then I can download the transaction receipt for "Within_Bank" transfer
#    Then I can add the "Within_Bank" transfer transaction to favourite "withinFav"
#    Then I can navigate to home clicking Go To Home for "Within_Bank" transfer