...
public class PG004_FundTransfer {
    ...
    public static By ownTransferDetailsScreenTitle = By.xpath("//h1[contains(text(),'Transfer Details')]");
    ...
    public static By ownTransferDetailsAvailableBalance = By.xpath("//body/app-root[1]/layout[1]/classy-layout[1]/div[1]/div[2]/app-bank-account-own-details[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[1]/div[1]");
    ...
    public static By fundTransferReviewPage = By.xpath("//h1[contains(text(),'Transfer Details Review')]");
    ...
    public static By fundTransferDownloadRecipt = By.xpath("//button[contains(text(),'Download Receipt')]");
